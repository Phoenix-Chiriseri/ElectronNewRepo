...
<x-layout bodyClass="g-sidenav-show bg-gray-200">
    ...
    <div class="main-content position-relative bg-gray-100 max-height-vh-100 h-100">
        ...
        @endif
        <!-- Navbar -->
        <x-navbars.navs.auth titlePage='Rate'></x-navbars.navs.auth>
        <!-- End Navbar -->
            ...
            <div class="card card-body mx-3 mx-md-4 mt-n6">
                    ...
                    <div class="col-auto my-auto">
                        <div class="h-100">
                            ...
                            <p class="mb-0 font-weight-normal text-sm">
                              ...
                              <small>Current Rate Set To {{$rate}}</small>
                            </p>
                        </div>
                    </div>
                </div>
                <div class="card card-plain h-100">
                    ...
                    <div class="card-body p-3">
                        ...
                        @endif
                        <form method="POST" action="{{ route('submit-rate') }}">
                        @csrf
                        <div class="form-group">
                            <label for="customer_name">Rate</label>
                            <input type="text" name="rate" id="rate" class="form-control border border-2 p-2" required>
                        </div>
                        <hr>
                        <div class="form-group">
                            <button type="submit" class="btn btn-primary">Create Zig Rate</button>
                        </div>
                    </form>
                    </div>
                </div>
