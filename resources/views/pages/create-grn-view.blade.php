                    ...
                    <div class="card-body p-3">
                        ...
                        <div class="row">
                            <div class="form-group">
                                ...
                                <div class="d-flex">
                                    <select name="supplier_id" class="form-control border border-2 p-2 me-2">
                                        <option value="">-- No Supplier --</option>
                                        @foreach ($suppliers as $supplier)
                                        <option value="{{ $supplier->id }}">{{ $supplier->supplier_name }}</option>
                                        @endforeach
                                    </select>
                                    <button type="button" class="btn btn-danger btn-sm" id="addSupplierBtn">
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-info" id="useWithoutSavingBtn">Use Without Saving</button>
                        <button type="button" class="btn btn-primary" id="saveSupplierBtn">Save & Use</button>
                    </div>
                </div>
            </div>
        </div>
