            ...
            <div class="card card-body mx-3 mx-md-4 mt-n6">
                ...
                <div class="card card-plain h-100">
                    ...
                    <div class="card-body p-3">
                        ...
                        @endif
                        <form method='POST' action="{{ route('search.grv') }}">
                            @csrf
                            <div class="row">  
                                ...
                                <div class="mb-3 col-md-12">
                                    ...
                                    <input type="date" name="start-date" class="form-control border border-2 p-2" required>
                                    @error('name')
                                ...
                                <div class="mb-3 col-md-12">
                                    ...
                                    <input type="date" name="end-date" class="form-control border border-2 p-2" required>
                                    @error('name')
                                <p class='text-danger inputerror'>{{ $message }} </p>
                                @enderror
                                </div>
