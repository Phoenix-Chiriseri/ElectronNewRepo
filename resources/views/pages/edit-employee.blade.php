                    ...
                    <div class="card-header pb-0 p-3">
                        <div class="row">
                            <div class="col-md-8 d-flex align-items-center">
                                <h6 class="mb-3">Edit A Employee</h6>
                            </div>
                        </div>
                    </div>
                        ...
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="row">
                                <div class="mb-3 col-md-12">
                                    ...
                                    <input type="text" name="name" class="form-control border border-2 p-2" value="{{$employee->name}}" required>
                                    @error('first_name')
                            ...
                            <div class="row">
                                <div class="mb-3 col-md-12">
                                    ...
                                    <input type="email" name="email" class="form-control border border-2 p-2" value="{{$employee->email}}" required>
                                    @error('first_name')
                                    <p class="text-danger inputerror">{{ $message }}</p>
                                    @enderror
                                </div>
                            ...
                            <div class="row">
                                <div class="mb-3 col-md-12">
                                    ...
                                    <input type="password" name="password" class="form-control border border-2 p-2"   value="{{$employee->password}}" required>
                                    @error('password')
                                    <p class="text-danger inputerror">{{ $message }}</p>
                                    @enderror
                                </div>
                            ...
                            <div class="row">
                                <div class="mb-3 col-md-12">
                                    ...
                                    <input type="password" name="password_confirmation" class="form-control border border-2 p-2" value="{{$employee->password}}" required>
                            ...
                            <hr>
                            <div class="form-group">
                                <button type="submit" class="btn btn-primary">Update Empleoyee</button>
                            </div>
                            <hr>
                        </form>
                    </div>
