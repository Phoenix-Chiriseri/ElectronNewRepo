            ...
            <div class="card card-body mx-3 mx-md-4 mt-n6">
                ...
                <div class="card card-plain h-100">
                    ...
                    <div class="card-body p-3">
                        ...
                        @endif
                        <form action="{{ route("edit-payment-type", $paymentType) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="row">       
                                <div class="mb-3 col-md-12">
                                    <label class="form-label">Payment Type Name</label>
                                    <input type="text" name="payment_type" value="{{$paymentType->payment_name}}" class="form-control border border-2 p-2" required>
                                    @error('name')
